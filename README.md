# Smart Insights: AI-Powered Data Analytics Platform
...
**Smart Insights** is a comprehensive, no-code data analytics and machine learning web application. It allows users to upload raw datasets and instantly receive interactive dashboards, predictive forecasts, plain-English explanations, and professional executive reports.
...
* **Machine Learning:** Scikit-learn (`IsolationForest`, `RandomForestRegressor`, `GradientBoostingRegressor`, `LinearRegression`, `Ridge`, `StandardScaler`)
